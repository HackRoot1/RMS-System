...
$fetch_user_orders_query = "SELECT * FROM customer_order WHERE user_id = {$user_data['id']} AND order_cancelled = 0 ORDER BY id DESC";
$fetch_user_orders = mysqli_query($conn, $fetch_user_orders_query);


$fetch_user_orders_history_query = "SELECT * FROM customer_order WHERE user_id = {$user_data['id']} AND order_cancelled = 1 ORDER BY id DESC";
